...
namespace Entitas {
    public partial class Entity {
        public Assets.Entitasteroids.Scripts.Sources.Features.View.ViewComponent view { get { return (Assets.Entitasteroids.Scripts.Sources.Features.View.ViewComponent)GetComponent(ComponentIds.View); } }

        public bool hasView { get { return HasComponent(ComponentIds.View); } }

        static readonly Stack<Assets.Entitasteroids.Scripts.Sources.Features.View.ViewComponent> _viewComponentPool = new Stack<Assets.Entitasteroids.Scripts.Sources.Features.View.ViewComponent>();
        ...
        public Entity AddView(UnityEngine.GameObject newGameObject) {
            var component = _viewComponentPool.Count > 0 ? _viewComponentPool.Pop() : new Assets.Entitasteroids.Scripts.Sources.Features.View.ViewComponent();
